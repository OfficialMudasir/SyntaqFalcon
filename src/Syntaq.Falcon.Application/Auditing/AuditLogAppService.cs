...
using Syntaq.Falcon.Auditing.Exporting;
using Syntaq.Falcon.Authorization;
using Syntaq.Falcon.Authorization.Users;
using Syntaq.Falcon.Dto;
using Syntaq.Falcon.EntityHistory;
using EntityHistoryHelper = Syntaq.Falcon.EntityHistory.EntityHistoryHelper;

namespace Syntaq.Falcon.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : FalconAppServiceBase, IAuditLogAppService
    {
