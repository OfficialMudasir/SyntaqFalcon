...
namespace Syntaq.Falcon.Authorization.Users.Importing
{
    public class UserListExcelDataReader : NpoiExcelImporterBase<ImportUserDto>, IUserListExcelDataReader
    {
        ...
        {
            _localizationSource = localizationManager.GetSource(FalconConsts.LocalizationSourceName);
        }
        ...
        private ImportUserDto ProcessExcelRow(ISheet worksheet, int row)
        {
            ...
            try
            {
                ...
                user.AssignedDisplayRoleNames = GetAssignedRoleNamesFromRow(worksheet, row, 6);
            }
