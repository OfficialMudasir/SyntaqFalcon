...
using Syntaq.Falcon.DemoUiComponents.Dto;

namespace Syntaq.Falcon.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : FalconAppServiceBase, IDemoUiComponentsAppService
    {
