...
using Syntaq.Falcon.Migrations.Seed.Host;
...
namespace Syntaq.Falcon.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : FalconAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<FalconDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{FalconConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{FalconConsts.ConnectionStringName}", constring);
        }
