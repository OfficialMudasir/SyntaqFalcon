...
namespace Syntaq.Falcon.MultiTenancy
{
    ...
    public class TenantAppService : FalconAppServiceBase, ITenantAppService
    {
        ...
        public async Task CreateTenant(CreateTenantInput input)
        {
            await TenantManager.CreateWithAdminUserAsync(input.TenancyName,
                ...
                AppUrlService.CreateEmailActivationUrlFormat(input.TenancyName, string.Empty),
                adminName:input.AdminName ?? input.AdminUserName,
