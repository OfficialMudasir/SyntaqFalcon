...
// REFACTOR FOR MERGE
namespace Syntaq.Falcon.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : FalconAppServiceBase, IOrganizationUnitAppService
    {
        ...
        public async Task<ListResultDto<OrganizationUnitDto>> GetOrganizationUnitsForSharing()
        {
        ...
        public PagedResultDto<OrganizationUnitUserListDto> GetOrganizationUnitUsersSync(GetOrganizationUnitUsersInput input)
        {
