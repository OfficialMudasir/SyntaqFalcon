...
{
    public class SessionAppService : FalconAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = FalconConsts.Currency,
                        CurrencySign = FalconConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = FalconConsts.AllowTenantsToChangeEmailSettings,
