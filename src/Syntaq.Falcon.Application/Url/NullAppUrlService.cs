...
namespace Syntaq.Falcon.Url
{
    public class NullAppUrlService : IAppUrlService
    {
        ...
        public string CreateEmailActivationUrlFormat(int? tenantId, string tenantname)
        {
        ...
        public string CreateEmailActivationUrlFormat(string tenancyName, string tenantname)
        {
            throw new NotImplementedException();
        }
