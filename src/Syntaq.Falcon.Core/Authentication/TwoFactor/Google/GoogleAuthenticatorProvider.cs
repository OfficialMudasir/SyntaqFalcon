...
namespace Syntaq.Falcon.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : FalconServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Syntaq.Falcon", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
