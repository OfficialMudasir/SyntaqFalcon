...
using Syntaq.Falcon.Authentication;
...
namespace Syntaq.Falcon.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!FalconConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[]
            {
                ...
                //STQ MODIFIED
                new SettingDefinition(AppSettings.HostManagement.PaymentFormId, GetFromAppSettings(AppSettings.HostManagement.PaymentFormId, "F40FE1FB-7F5A-4AAF-92C5-0D0D50FBEF5C"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.HostManagement.StripeClientId, GetFromAppSettings(AppSettings.HostManagement.StripeClientId, ""), scopes: SettingScopes.Tenant)
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        FalconConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant),

                //STQ MODIFIED
               new SettingDefinition(AppSettings.TenantManagement.PaymentFormId, GetFromAppSettings(AppSettings.TenantManagement.PaymentFormId, "F40FE1FB-7F5A-4AAF-92C5-0D0D50FBEF5C"), scopes: SettingScopes.Tenant),
               new SettingDefinition(AppSettings.TenantManagement.StripeClientId, GetFromAppSettings(AppSettings.TenantManagement.StripeClientId, ""), scopes: SettingScopes.Tenant)
        ...
        private IEnumerable<SettingDefinition> GetSharedSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.UserManagement.IsUserAcceptanceRequired, GetFromAppSettings(AppSettings.UserManagement.IsUserAcceptanceRequired, "false"), scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        FalconDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        FalconDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = FalconDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        Name = FalconDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            //new Widget
                            //{
                            //    WidgetId = FalconDashboardCustomizationConsts.Widgets.Host
                            //        .TopStats, // Top Stats
                            //    Height = 6,
                            //    Width = 12,
                            //    PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    FalconDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = FalconDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        ...
                        Widgets = new List<Widget>
                        {
                            new Widget
                                {
                                    WidgetId = FalconDashboardCustomizationConsts.Widgets.Tenant.ProjectRecentDocuments, // Submission Limit
                                    Height = 8,
                                    Width = 7,
                                    PositionX = 0,
                                    PositionY = 19
                                ...
                                new Widget
                                {
                                    WidgetId = FalconDashboardCustomizationConsts.Widgets.Tenant.StartNewProject, // Today Submissions
                                    Height = 8,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 19
                                ...
                                new Widget
                                {
                                    WidgetId = FalconDashboardCustomizationConsts.Widgets.Tenant.WaitingContributor, // New Users
                                    Height = 10,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 30
                                ...
                                new Widget
                                {
                                    WidgetId = FalconDashboardCustomizationConsts.Widgets.Tenant.WaitingOthers, // Most Recent Submissions
                                    Height = 10,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 40
                ...
                Pages = new List<Page>
                {
                    new Page
                    {
                        ...
                        Widgets = new List<Widget>
                        {
                            //new Widget
                            //{
                            //    WidgetId = FalconDashboardCustomizationConsts.Widgets.Tenant
                            //        .TopStats, // Top Stats
                            //    Height = 4,
                            //    Width = 12,
                            //    PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    FalconDashboardCustomizationConsts.Widgets.Tenant
