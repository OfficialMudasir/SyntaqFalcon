namespace Syntaq.Falcon.Configuration
{
    ...
    public static class AppSettings
    {
        public static class HostManagement
        {
            ...
            //STQ MODIFIED
            public const string PaymentFormId = "App.HostManagement.Payments.PaymentFormId";
            public const string StripeClientId = "App.HostManagement.Payments.StripeClientId";
        ...
        public static class TenantManagement
        {
            ...
            public const string PaymentFormId = "App.TenantManagement.Payments.PaymentFormId";
            public const string StripeClientId = "App.TenantManagement.Payments.StripeClientId";
        }
        ...
        public static class UserManagement
        {
            ...
            public const string IsUserAcceptanceRequired = "App.UserManagement.IsUserAcceptanceRequired";
            //public const string PaymentFormId = "App.UserManagement.IsQuickThemeSelectEnabled";
        }
