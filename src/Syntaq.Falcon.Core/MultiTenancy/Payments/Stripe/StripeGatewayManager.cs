...
{
    public class StripeGatewayManager : FalconServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Falcon";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + FalconConsts.Currency;
        }
