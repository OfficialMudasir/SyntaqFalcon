...
{
    public class FalconMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public FalconMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(FalconConsts.LocalizationSourceName, name);
        }
    }
}