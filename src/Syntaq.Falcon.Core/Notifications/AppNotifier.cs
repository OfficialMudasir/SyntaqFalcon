...
{
    public class AppNotifier : FalconDomainServiceBase, IAppNotifier
    {
        ...
        // STQ MODIFIED
        // Send Create or Update Templates Notification
        public async Task CreateOrUpdateTemplateMessage(User user, string message)
        {
