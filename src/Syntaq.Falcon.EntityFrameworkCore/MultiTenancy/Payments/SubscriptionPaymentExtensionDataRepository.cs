...
{
    public class SubscriptionPaymentExtensionDataRepository : FalconRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<FalconDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
