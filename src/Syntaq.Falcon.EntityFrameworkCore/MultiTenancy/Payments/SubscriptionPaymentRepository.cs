...
{
    public class SubscriptionPaymentRepository : FalconRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<FalconDbContext> dbContextProvider)
