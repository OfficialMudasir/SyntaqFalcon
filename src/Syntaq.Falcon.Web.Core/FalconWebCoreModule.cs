...
using Syntaq.Falcon.Authentication.TwoFactor;
...
using Syntaq.Falcon.Web.Authentication.JwtBearer;
using Syntaq.Falcon.Web.Authentication.TwoFactor;
using Syntaq.Falcon.Web.Chat.SignalR;
using Syntaq.Falcon.Web.Common;
using Syntaq.Falcon.Web.Configuration;
...
namespace Syntaq.Falcon.Web
{
    ...
    public class FalconWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FalconWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(FalconApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FalconWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(FalconWebCoreModule).Assembly);
        }
