...
using Syntaq.Falcon.Web.Areas.Falcon.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : FalconControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            var availableWidgets = await DashboardCustomizationAppService.GetAllAvailableWidgetDefinitionsForPage(
                ...
                {
                    Application = FalconDashboardCustomizationConsts.Applications.Mvc,
                    PageId = pageId,
            ...
            return PartialView(
                "~/Areas/Falcon/Views/Shared/Components/CustomizableDashboard/_AddWidgetModal.cshtml",
                viewModel
            );
        }
        ...
        protected async Task<ActionResult> GetView(string dashboardName)
        {
            ...
            return View("~/Areas/Falcon/Views/Shared/Components/CustomizableDashboard/Index.cshtml",
