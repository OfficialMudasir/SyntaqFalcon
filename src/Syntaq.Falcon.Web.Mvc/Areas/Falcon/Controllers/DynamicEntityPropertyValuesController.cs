...
using Syntaq.Falcon.Web.Areas.Falcon.Models.DynamicEntityPropertyValues;
...
namespace Syntaq.Falcon.Web.Areas.Falcon.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : FalconControllerBase
    {
        ...
        [HttpGet("/Falcon/DynamicEntityPropertyValue/ManageAll/{entityFullName}/{entityId}")]
