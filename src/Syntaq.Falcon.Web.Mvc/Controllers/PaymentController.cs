...
using Syntaq.Falcon.Web.Models.Payment;
using System;
...
{
    public class PaymentController : FalconControllerBase
    {
                ...
                if (tenant.EditionId.HasValue)
                {
                    ...
                    if (((SubscribableEdition)currentEdition).IsFree)
                    {
                        ...
                        if (((SubscribableEdition)upgradeEdition).IsFree)
                        {
                            ...
                            return RedirectToAction("Index", "SubscriptionManagement", new { area = "Falcon" });
                        }
