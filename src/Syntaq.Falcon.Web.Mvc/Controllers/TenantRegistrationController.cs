...
using Syntaq.Falcon.Web.Models.TenantRegistration;

namespace Syntaq.Falcon.Web.Controllers
{
    public class TenantRegistrationController : FalconControllerBase
    {
            ...
            try
            {
                    ...
                    !_webUrlService.SupportsTenancyNameInUrl)
                {
                    ...
                    if (loginResult.Result == AbpLoginResultType.Success)
                    {
                        ...
                        return Redirect(Url.Action("Index", "Home", new { area = "Falcon" }));
                    }
