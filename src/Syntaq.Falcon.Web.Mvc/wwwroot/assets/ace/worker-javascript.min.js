...
function initSender() {
    var e = require(null, "ace/lib/event_emitter").EventEmitter,
...
onmessage = function (e) {
    ...
    var r = function () {
        ...
        function bt(e, t, n, i, s, o) {
            var u, a, f;
            return t = t || C, t.id === "(end)" && (t = z), a = t.line || 0, u = t.from || 0, f = {
                id: "(error)",
                raw: e,
                evidence: E[a - 1] || "",
                line: a,
                ...
                c: s,
                d: o
            }, f.reason = pt(e, f), r.errors.push(f), A.passfail && gt("Stopping. ", a, u), $ += 1, $ >= A.maxerr && gt("Too many errors.", a, u), f
        }
        ...
        function Ct() {
            ...
            e: for (; ;) {
                ...
                if (v.id === ":") {
                    ...
                    if (g.indexOf(p.value) > -1 && (t === "/*jshint" || t === "/*jslint")) a = +v.value, (typeof a != "number" || !isFinite(a) || a <= 0 || Math.floor(a) !== a) && Et("Expected a small integer and instead saw '{a}'.", v, v.value), p.value === "indent" && (l.white = !0), l[p.value] = a;
                    else if (p.value === "validthis") h["(global)"] ? Et("Option 'validthis' can't be used in a global scope.") : v.value === "true" || v.value === "false" ? l[p.value] = v.value === "true" : Et("Bad option value.", v);
                    else if (p.value === "quotmark" && t === "/*jshint") switch (v.value) {
                        case "true":
                            l.quotmark = !0;
                            break;
                        case "false":
        ...
        function Lt(t, n) {
            ...
            for (; ;) {
                ...
                if (C.type === "special") Ct();
                else if (C.id !== "(endline)") break
            }
        }
        ...
        function on() {
            ...
            for (; ;) {
                if (C.id === "(string)") {
                    ...
                    } else if (t.id === "}") bt("Missing semicolon.", t);
                    else if (t.id !== ";") break;
        ...
        function hn(t, n) {
            var r, i = A,
                s = B;
            return A = Object.create(A), B = Object.create(B), h = {
                "(name)": t || '"' + e + '"',
                "(line)": C.line,
                ...
                "(statement)": n,
                "(tokens)": {}
            }, r = h, z.funct = h, d.push(h), t && Nt(t, "function"), h["(params)"] = cn(), h["(metrics)"].verifyMaxParametersPerFunction(h["(params)"]), un(!1, !1, !0), h["(metrics)"].verifyMaxStatementsPerFunction(), h["(metrics)"].verifyMaxComplexityPerFunction(), B = s, A = i, h["(last)"] = z.line, h["(lastcharacter)"] = z.character, h = h["(context)"], r
        }
        ...
        function mn() {
            function e() {
                ...
                if (C.id !== "}")
                    for (; ;) {
                        if (C.id === "(end)") Et("Missing '}' to match '{' from line {a}.", C, t.line);
                        else {
                            if (C.id === "}") {
            ...
            function t() {
                ...
                if (C.id !== "]")
                    for (; ;) {
                        if (C.id === "(end)") Et("Missing ']' to match '[' from line {a}.", C, e.line);
                        else {
                            if (C.id === "]") {
                                bt("Unexpected comma.", z);
                                break
        ...
        var e, t = {
            ...
            h, p = ["closure", "exception", "global", "label", "outer", "unused", "var"],
            d, v, m, g, y, b, w = {
                $: !1,
                jQuery: !1
            },
        ...
        var Tt = function () {
            ...
            function o(e, i) {
                ...
                return e === "(color)" || e === "(range)" ? o = {
                    type: e
                } : e === "(punctuator)" || e === "(identifier)" && ut(R, i) ? o = R[i] || R["(error)"] : o = R[e], o = Object.create(o), (e === "(string)" || e === "(range)") && !A.scripturl && it.test(i) && wt("Script URL.", r, n), e === "(identifier)" && (o.identifier = !0, u(i)), o.value = i, o.line = r, o.character = t, o.from = n, s = o.id, s !== "(endline)" && (M = s && ("(,=:[!&|?{};".indexOf(s.charAt(s.length - 1)) >= 0 || s === "return" || s === "case")), o
            }
            var t, n, r, i;
            return {
                init: function (e) {
                                    ...
                                    if (M) {
                                        ...
                                        for (; ;) {
                                            ...
                                            switch (u) {
                                                ...
                                                case "/":
                                                    l > 0 && wt("{a} unterminated regular expression group(s).", r, n + p, l), u = i.substr(0, p - 1), v = {
                                                        g: !0,
                                                        i: !0,
                                                        m: !0
                                                    };
        ...
        Wt("(number)", function () {
            ...
            nud: function () {
                ...
                if (h === n) switch (h[t]) {
                ...
                } else if (h["(global)"]) A.undef && typeof O[t] != "boolean" && (e !== "typeof" && e !== "delete" || C && (C.value === "." || C.value === "[")) && yt(h, "'{a}' is not defined.", z, t), fn(z);
                else switch (h[t]) {
                    case "closure":
                    case "function":
                    case "var":
                    ...
                    default:
                        if (n === !0) h[t] = !0;
                        else if (n === null) bt("'{a}' is not allowed.", z, t), fn(z);
                        else if (typeof n != "object") A.undef && (e !== "typeof" && e !== "delete" || C && (C.value === "." || C.value === "[")) && yt(h, "'{a}' is not defined.", z, t), h[t] = !0, fn(z);
                        else switch (n[t]) {
                            case "function":
                            case "unction":
            ...
            if (e && e.id !== "function")
                ...
                } else e.id !== "." && e.id !== "[" && e.id !== "(" && bt("Bad constructor.", z);
            else A.supernew || bt("Weird construction. Delete 'new'.", this);
            ...
            function (e) {
                e.nud = function () {
                    ...
                    for (; ;) {
                        if (C.id === "}") break;
                        e && Ht();
                        if (C.value === "get" && kt().id !== ":") Lt("get"), A.es5 || Et("get/set are ES5 features."), n = ln(), n || Et("Missing property name."), a(n), i = C, Ot(z, C), t = hn(), r = t["(params)"], r && bt("Unexpected parameter '{a}' in get {b} function.", i, r[0], n), Ot(z, C);
                        else if (C.value === "set" && kt().id !== ":") Lt("set"), A.es5 || Et("get/set are ES5 features."), n = ln(), n || Et("Missing property name."), u(n, C), i = C, Ot(z, C), t = hn(), r = t["(params)"], (!r || r.length !== 1) && bt("Expected a single parameter in set {a} function.", i, n);
                        else {
                            n = ln(), o(n, C);
                    ...
                    if (A.es5)
                        for (var f in s) ut(s, f) && s[f].setter && !s[f].getter && bt("Setter is defined without getter.", s[f].setterToken);
                    return this
                }, e.fud = function () {
        ...
        vn.exps = !0, Rt("function", function () {
            ...
            var e = tn();
            return A.esnext && h[e] === "const" && bt("const '" + e + "' has already been declared"), Ot(z, C), Nt(e, "unction", z), hn(e, {
                statement: !0
            }), C.id === "(" && C.line === z.line && Et("Function declarations are not invocable. Wrap the whole function invocation in parens."), this
            ...
            function t() {
                var e = B,
                    t;
                Lt("catch"), Dt(z, C), Lt("("), B = Object.create(e), t = C.value, C.type !== "(identifier)" && (t = null, bt("Expected an identifier and instead saw '{a}'.", C, t)), Lt(), Lt(")"), h = {
                    "(name)": "(catch)",
                    "(line)": C.line,
                    "(character)": C.character,
                    "(context)": h,
                    ...
                    "(catch)": !0,
                    "(tokens)": {}
                }, t && Nt(t, "exception"), z.funct = h, d.push(h), un(!1), B = e, h["(last)"] = z.line, h["(lastcharacter)"] = z.character, h = h["(context)"]
            }
            var e;
            ...
            function () {
                ...
                if (kt(C.id === "var" ? 1 : 0).id === "in") {
                    if (C.id === "var") Lt("var"), vn.fud.call(vn, !0);
                    else {
                        switch (h[C.value]) {
                            case "unused":
                                h[C.value] = "var";
                ...
                if (C.id !== ";")
                    if (C.id === "var") Lt("var"), vn.fud.call(vn);
                    else
                        for (; ;) {
                            At(0, "for");
                            if (C.id !== ",") break;
        ...
        var gn = function (e, t, n) {
            ...
            y = 1, v = Object.create(O), B = v, h = {
                ...
                "(tokens)": {},
                "(metrics)": pn(C)
            }, d = [h], X = [], j = null, x = {}, T = null, m = {}, g = !1, S = [], b = !1, $ = 0, E = [], W = [];
            ...
            try {
                ...
                var p = function (e, t) {
                    ...
                    N = function (e, t) {
                        var n = t.line,
                            r = t.character;
                        A.unused && wt("'{a}' is defined but never used.", n, r, e), W.push({
                            name: e,
                            line: n,
                            character: r
                        })
