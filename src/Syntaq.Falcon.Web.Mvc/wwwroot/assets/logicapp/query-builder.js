...
QueryBuilder.OPERATORS = {
    ...
    between: { type: 'between', nb_inputs: 2, multiple: false, apply_to: ['string', 'number', 'datetime'] },
    not_between: { type: 'not_between', nb_inputs: 2, multiple: false, apply_to: ['string', 'number', 'datetime'] },
    begins_with:      { type: 'begins_with',      nb_inputs: 1, multiple: false, apply_to: ['string', 'string'] },
