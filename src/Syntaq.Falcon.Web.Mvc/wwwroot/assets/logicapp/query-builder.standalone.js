...
(function (root, factory) {
    ...
    QueryBuilder.OPERATORS = {
        ...
        is_empty: { type: 'is_empty', nb_inputs: 0, multiple: false, apply_to: ['string', 'number', 'datetime'] },
        is_not_empty: { type: 'is_not_empty', nb_inputs: 0, multiple: false, apply_to: ['string', 'number', 'datetime'] }
