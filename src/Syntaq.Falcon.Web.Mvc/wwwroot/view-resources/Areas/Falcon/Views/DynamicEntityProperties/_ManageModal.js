(function () {
  app.modals.ManageDynamicEntityPropertyModal = function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/DynamicEntityProperty/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/DynamicEntityProperties/_CreateModal.js',
