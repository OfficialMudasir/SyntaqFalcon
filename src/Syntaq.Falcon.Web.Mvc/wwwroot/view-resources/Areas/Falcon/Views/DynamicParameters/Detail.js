(function () {
    $(function () {
        ...
        var _createOrEditDynamicParameterModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Falcon/DynamicParameter/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/DynamicParameters/_CreateOrEditModal.js',
        ...
        var _createOrEditDynamicParameterValueModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Falcon/DynamicParameter/CreateOrEditValueModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/DynamicParameters/_CreateOrEditValueModal.js',
                ...
                function (isConfirmed) {
                    if (isConfirmed) {
                        ...
                        _dynamicParameterAppService.delete(id)
                            .done(function () {
                                window.location.href = "/Falcon/DynamicParameter";
