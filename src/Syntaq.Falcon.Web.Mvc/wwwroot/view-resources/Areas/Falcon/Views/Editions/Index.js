...
(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Falcon/Editions/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/Editions/_CreateModal.js',
            modalClass: 'CreateOrEditEditionModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Falcon/Editions/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/Editions/_EditModal.js',
            modalClass: 'CreateOrEditEditionModal'
        });

        var _moveTenantsToAnotherEditionModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Falcon/Editions/MoveTenantsToAnotherEdition',
            scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/Editions/_MoveTenantsToAnotherEditionModal.js',
        ...
        var dataTable = _$editionsTable.DataTable({
            ...
            createdRow: function (row, data, dataIndex) {
                $(row).find("td:nth-child(1),td:nth-child(2),td:nth-child(3),td:nth-child(4),td:nth-child(5)").on("click", function () {
