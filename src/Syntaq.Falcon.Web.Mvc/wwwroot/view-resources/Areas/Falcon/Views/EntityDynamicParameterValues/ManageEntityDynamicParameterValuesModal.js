(function () {
    ...
    app.modals.ManageEntityDynamicParameterValuesModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Falcon/EntityDynamicParameterValue/ManageEntityDynamicParameterValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/EntityDynamicParameterValues/ManageEntityDynamicParameterValuesModal.js',
