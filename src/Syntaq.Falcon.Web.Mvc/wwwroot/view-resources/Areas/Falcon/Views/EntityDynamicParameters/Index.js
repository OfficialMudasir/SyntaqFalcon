(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Falcon/EntityDynamicParameter/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/EntityDynamicParameters/_CreateModal.js',
        ...
        _table.find('tbody').on('click', 'tr', function () {
            ...
            if (data) {
                window.location = "/Falcon/EntityDynamicParameter/Detail/" + data.entityFullName;
            }
        });
