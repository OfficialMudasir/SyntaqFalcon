(function ($) {
  $(function () {
    ...
    var mySettingsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/Profile/MySettingsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/Profile/_MySettingsModal.js',
    ...
    var changePasswordModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/Profile/ChangePasswordModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/Profile/_ChangePasswordModal.js',
    ...
    var changeProfilePictureModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/Profile/ChangePictureModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/Profile/_ChangePictureModal.js',
    ...
    var manageLinkedAccountsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/Profile/LinkedAccountsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/Profile/_LinkedAccountsModal.js',
    ...
    var userDelegationsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/Profile/UserDelegationsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/Profile/_UserDelegationsModal.js',
