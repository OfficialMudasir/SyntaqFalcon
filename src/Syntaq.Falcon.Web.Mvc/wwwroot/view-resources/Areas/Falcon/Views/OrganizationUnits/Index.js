(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/OrganizationUnits/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/OrganizationUnits/_CreateModal.js',
      modalClass: 'CreateOrganizationUnitModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/OrganizationUnits/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/OrganizationUnits/_EditModal.js',
      modalClass: 'EditOrganizationUnitModal',
    });

    var _addUserModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/OrganizationUnits/AddMemberModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/OrganizationUnits/_AddMemberModal.js',
    ...
    var _addRoleModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/OrganizationUnits/AddRoleModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/OrganizationUnits/_AddRoleModal.js',
