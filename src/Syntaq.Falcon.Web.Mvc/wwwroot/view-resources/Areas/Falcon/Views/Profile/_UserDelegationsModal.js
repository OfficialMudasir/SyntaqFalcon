(function ($) {
  app.modals.UserDelegationsModal = function () {
    ...
    var _createNewUserDelegationModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Falcon/Profile/CreateNewUserDelegationModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/Profile/_CreateNewUserDelegationModal.js',
