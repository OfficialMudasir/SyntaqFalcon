...
(function () {
    $(function () {
        ...
        var _entityTypeFullName = 'Syntaq.Falcon.MultiTenancy.Tenant';
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + "Falcon/Tenants/CreateModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Falcon/Views/Tenants/_CreateModal.js",
            modalClass: "CreateTenantModal"
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + "Falcon/Tenants/EditModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Falcon/Views/Tenants/_EditModal.js",
            modalClass: "EditTenantModal"
        });

        var _featuresModal = new app.ModalManager({
            viewUrl: abp.appPath + "Falcon/Tenants/FeaturesModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Falcon/Views/Tenants/_FeaturesModal.js",
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (isActive) {
                        if (isActive) {
                            return '<span class="kt-badge kt-badge--success kt-badge--inline">' + app.localize('Yes') + '</span>';
                        } else {
                            return '<span class="kt-badge kt-badge--dark kt-badge--inline">' + app.localize('No') + '</span>';
                        }
                    }
                },
                {
        ...
        $('#TenantsTableFilter').keyup(function (event) {
            // On enter
            if (event.keyCode === 13) {
                getTenants();
            }
