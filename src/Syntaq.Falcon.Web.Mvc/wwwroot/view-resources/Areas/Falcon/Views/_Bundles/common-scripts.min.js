...
(function ($) {
    app.UserNotificationHelper = (function () {
        return function () {
            ...
            /* Example:
                  abp.notifications.messageFormatters['Syntaq.Falcon.MyNotificationDataType'] = function(userNotification) {
            ...
            function getUrl(userNotification) {
                switch (userNotification.notification.notificationName) {
                    case 'App.NewUserRegistered':
                        return '/Falcon/users?filterText=' + userNotification.notification.data.properties.emailAddress;
                    case 'App.NewTenantRegistered':
                        return '/Falcon/tenants?filterText=' + userNotification.notification.data.properties.tenancyName;
            ...
            var openSettingsModal = function () {
                new app.ModalManager({
                    viewUrl: abp.appPath + 'Falcon/Notifications/SettingsModal',
                    scriptUrl: abp.appPath + 'view-resources/Areas/Falcon/Views/Notifications/_SettingsModal.js',
...
(function ($) {
    ...
    var _createButtonDropdown = function (record, field) {
        ...
        var $dropdownButton = $('<button/>')
            ...
            .addClass('btn btn-secondary btn-sm dropdown-toggle')
...
var app = app || {};
(function () {
    var appLocalizationSource = abp.localization.getSource('Falcon');
