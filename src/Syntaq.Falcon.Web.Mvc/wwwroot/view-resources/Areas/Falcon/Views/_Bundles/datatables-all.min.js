...
(function ($) {
	...
	***/
	...
	//        console.log('Language is set to English for datatables, because locale is not found!');
	//    }).always(function () {
	//        $.extend(true, $.fn.dataTable.defaults, {
	//            language: {
	//                url: translationsUrl
...
(function ($) {
	...
	var _createButtonDropdown = function (record, field) {
		...
		var $dropdownButton = $('<button/>')
			.html(field.text)
			.addClass('btn btn-secondary m-btn m-btn--custom m-btn--label-accent m-btn--bolder    dropdown-toggle')
