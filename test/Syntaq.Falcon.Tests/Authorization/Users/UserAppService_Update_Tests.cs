...
namespace Syntaq.Falcon.Tests.Authorization.Users
{
    ...
    public class UserAppService_Update_Tests : UserAppServiceTestBase
    {
        ...
        public async Task Should_Not_Update_User_With_Duplicate_Username_Or_EmailAddress()
        {
            ...
            //exception.Message.ShouldContain("adams_d"); // Cannot return identifiable information i nthe error message just return invalid
            exception.Message.ShouldContain("[User name or email invalid]");
