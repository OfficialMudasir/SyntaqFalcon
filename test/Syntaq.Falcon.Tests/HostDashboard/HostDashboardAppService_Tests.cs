...
using Syntaq.Falcon.MultiTenancy.HostDashboard;
...
namespace Syntaq.Falcon.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(FalconDbContext context, SubscriptionPayment subscriptionPayment)
        {
